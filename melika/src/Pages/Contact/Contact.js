  ...
  return (
    <>
      <section class="py-3 py-md-5 py-xl-8"  >
        <div class="container text-center">
          <div class="row">
            <div class="col-12 col-md-10 col-lg-8">
              <h3 class="fs-3 mb-2 text-secondary text-uppercase" style={{fontFamily:'cursive'}}>Get in touch</h3>
              <span class="display-5 mb-4 mb-md-5 mb-xl-8" style={{color:'#a6a6a6',fontSize:'16px'}}>
                Contact Me
              </span>
            </div>
          </div>
        ...
        <div class="container" style={{width:'60%', margin:'auto' ,paddingTop:'5rem'}}>
          <div class=" gy-4 gy-md-5 gy-lg-0 align-items-md-center Contactitem">
            <div class="col-12 col-lg-12">
              <div class="border overflow-hidden">
                <form action="#!">
                  <div class="column gy-4 gy-xl-5  p-xl-5">
                    <div class="col-12">
            ...
            <div class="col-6 col-lg-6 pb-3 mb-5 mx-0 px-0">
              <div class="row justify-content-xl-center">
                <div class="col-6 col-xl-11">
